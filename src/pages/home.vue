<template>
  <div class="home">
    <div class="itemList">
      <div class="item" @click="goPage('/player/list')">
      ...
      <div class="item" @click="goPage('/statistics')">
        <el-icon class="img" style="color:#E6A23C"><Management /></el-icon>
        <div class="name">统计设置</div>
      </div>
      <div class="item" @click="goPage('/vote/log')">
